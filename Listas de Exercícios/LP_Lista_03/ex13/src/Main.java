    ...
    public static void main(String[] args) {
        ...
        switch (option){
            case 1:
                ...
                System.out.println("O perímetro é: " + p + " e a área é: " + a);
                break;
            case 2:
                System.out.println("Indique a base do triângulo retângulo: ");
                b = in.nextDouble();
                System.out.println("Indique a altura do triângulo retângulo: ");
                h = in.nextDouble();
                System.out.println("Indique o lado do triângulo retângulo: ");
                c = in.nextDouble();
